  ...
  it "should reject names that are too long" do
   ...
   it "should accept valid email addresses" do
    ...
    describe "password encryption"  do
        ...
        it "should have an encrypted passwort attribute" do
        ...
        describe "status feed" do
          ...
          it "should not include a different user's microposts" do 
                mp3 = Factory(:micropost, 
                              :user => Factory(:user, :name => "user1", :email => "user1@xy.de")) 
                @user.feed.should_not include(mp3)
          end
          
          it "should include the microposts of followed users" do 
              followed = Factory(:user, :name => "user1", :email => "user1@xy.de")  
     ...
     describe "status feed" do
        ...
        before(:each) do
            ...
            it "should have a feed" do 
             ...
             it "should not include a different user's microposts" do 
                 mp3 = Factory(:micropost, :user => Factory(:user, :name => "abc", :email => "abc@xy.de")) 
